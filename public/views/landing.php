        ...
        <section class="hero">
            ...
            <div class="platforms-row">
                ...
                <div class="platform-icon threads" data-tooltip="Threads">
                    <svg viewBox="0 0 24 24"><path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.361-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.96-.065-1.182.408-2.256 1.332-3.023.88-.73 2.087-1.146 3.398-1.172 1.163-.022 2.318.155 3.478.528-.034-.923-.209-1.71-.527-2.33-.477-.933-1.265-1.428-2.395-1.428h-.07c-.822.012-1.476.27-1.944.77l-1.483-1.488c.791-.79 1.862-1.2 3.165-1.29h.118c1.689-.03 3.097.55 4.062 1.672.894 1.039 1.366 2.496 1.4 4.324 0 .06.003.122.003.183.059.406.09.823.09 1.246 0 4.26-2.88 7.584-7.15 8.11a9.92 9.92 0 01-1.196.073zm-.09-7.874c-.08 0-.16.002-.238.006-.73.04-1.3.25-1.697.625-.396.374-.58.87-.545 1.476.033.575.258 1.053.671 1.422.438.39 1.058.59 1.786.553.954-.048 1.692-.378 2.193-1.003.348-.434.594-1.004.74-1.715-.97-.3-1.95-.39-2.91-.364z"/></svg>
                </div>
